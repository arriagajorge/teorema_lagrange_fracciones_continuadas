...
\section*{Fracciones continuadas simples}
    ...
    \end{comment}
     \begin{thebibliography}{9}
        ...
        \bibitem{Niven} Niven I., Zuckerman S. H., Montgomery L. H., \textit{An introduction to the theory of numbers}, Wiley, 1991.
    
        \bibitem{Olds} Olds C. D., \textit{Continued fractions}, New mathematical library, Random House, 1963.
     
        \bibitem{Silverman} Silverman H. Joseph, \textit{A friendly introduction to number theory}, Pearson, 2012.
    \end{thebibliography}
